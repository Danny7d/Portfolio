          ...
          <div className="hidden md:flex items-center space-x-8">
            {navItems.map((item) => (
              <Link
                key={item.path}
                href={item.path}
                className="relative group px-4 py-2 rounded-full transition-all duration-300 text-gray-300 hover:text-white"
              >
          ...
          <div className="flex flex-col space-y-2 py-4">
            {navItems.map((item) => (
              <Link
                ...
                className="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-300 text-gray-300 hover:bg-white/10 hover:text-white"
              >
